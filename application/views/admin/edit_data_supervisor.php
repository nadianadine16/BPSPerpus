  ...
  <div class="container-fluid">
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Edit Data Supervisor Perpustakaan BPS Kota Malang</h6>
        </div>
        <div class="card-body">
            ...
            <form action="<?=base_url('User/edit_data_supervisor/'.$admin['id_user'])?>" method="post">
